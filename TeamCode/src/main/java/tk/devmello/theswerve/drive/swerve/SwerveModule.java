...
import tk.devmello.mellolib.swerve.util.AbsoluteAnalogEncoder;
...
public class SwerveModule {
    ...
    public SwerveModule(DcMotorEx m, CRServo s, Encoder e) {
        motor = m;
    ...
    public SwerveModule(HardwareMap hardwareMap, String mName, String sName, String eName) {
        this(hardwareMap.get(DcMotorEx.class, mName),
                ...
                new Encoder(hardwareMap.get(DcMotorEx.class, eName)));
    }
